...
func (c *deliveryClient) ScheduleDelivery(ctx context.Context, in *ScheduleDeliveryRequest, opts ...grpc.CallOption) (*ScheduleDeliveryResponse, error) {
	out := new(ScheduleDeliveryResponse)
	err := c.cc.Invoke(ctx, "/delivery.Delivery/ScheduleDelivery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDeliveryServer) ScheduleDelivery(context.Context, *ScheduleDeliveryRequest) (*ScheduleDeliveryResponse, error) {
...
func _Delivery_ScheduleDelivery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScheduleDeliveryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeliveryServer).ScheduleDelivery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/delivery.Delivery/ScheduleDelivery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeliveryServer).ScheduleDelivery(ctx, req.(*ScheduleDeliveryRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Delivery_ScheduleDelivery_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/grpc/delivery/delivery.proto",
}
